...
var feed = new Instafeed({
    ...
    template: '<div class="insta-image" style="background-image: url({{image}});background-size: cover;height:285px;"><div class="social-buttons"> <table> <tr> <td><a href="https://twitter.com/slqld"><img src="'+jsFileLocation+'img/social/iconmonstr-twitter-4-icon.svg" class="social-icon"/></a></td><td><a href="https://www.facebook.com/statelibraryqld/"><img src="'+jsFileLocation+'img/social/iconmonstr-facebook-4-icon.svg" class="social-icon"/></a></td><td><a href="https://www.instagram.com/statelibraryqld/"><img src="'+jsFileLocation+'img/social/iconmonstr-instagram-9-icon.svg" class="social-icon active-social-data"/></a></td></tr><tr> <td><a href="https://au.pinterest.com/SLQShop/"><img src="'+jsFileLocation+'img/social/iconmonstr-pinterest-1.svg" class="social-icon"/></a></td><td><a href="https://vimeo.com/statelibraryqld"><img src="'+jsFileLocation+'img/social/iconmonstr-vimeo-4-icon.svg" class="social-icon"/></a></td><td><a href="https://www.youtube.com/user/statelibraryqld"><img src="'+jsFileLocation+'img/social/iconmonstr-youtube-4-icon.svg" class="social-icon"/></a></td></tr><tr> <td><img src="'+jsFileLocation+'img/social/iconmonstr-map-icon.svg" class="social-icon"/></td><td><img src="'+jsFileLocation+'img/social/iconmonstr-layer-6-icon.svg" class="social-icon"/></td><td><img src="'+jsFileLocation+'img/social/iconmonstr-light-bulb-3-icon.svg" class="social-icon"/></td></tr></table> </div></div>'
